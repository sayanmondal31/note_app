...
// ignore: unused_element
  CancelledByUser camcelledByUser() {
...
mixin _$AuthFailure {
  ...
  Result when<Result extends Object>({
    @required Result camcelledByUser(),
  ...
  Result map<Result extends Object>({
    @required Result camcelledByUser(CancelledByUser value),
  ...
  Result maybeMap<Result extends Object>({
    Result camcelledByUser(CancelledByUser value),
...
class _$CancelledByUser implements CancelledByUser {
  ...
  @override
  String toString() {
    return 'AuthFailure.camcelledByUser()';
  }
  ...
  Result when<Result extends Object>({
    ...
    assert(camcelledByUser != null);
    assert(serverError != null);
    assert(emailAlreadyInUse != null);
    assert(invalidEmailAndPasswordCombination != null);
    return camcelledByUser();
  }
